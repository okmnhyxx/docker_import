...
public class TigerConstructor extends Animal{
	
	String fury;
	TigerConstructor(){
		System.out.println("======================wucangouzao");
	}
	TigerConstructor(String name, Double weight){//注意   加不加super  各调什么?
		super(name,weight);
		this.name = name;
		this.weight = weight;
		System.out.println("======================youcangouzaoxiao");
	}
	TigerConstructor(String name, String weight, String fury){
		System.out.println("======================youcangouzaoda");
	}
	
	public static void main(String[] args) {
		new TigerConstructor("Mimi",12.3).run();
	}
}
